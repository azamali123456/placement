...
export class MailService {
  ...
  private async verifySenderIdentity(email: string): Promise<void> {
  ...
  async sendNewMail(to: any, from: any, subject: any, heading: any, body: any, attachments: any): Promise<any> {
    try {
